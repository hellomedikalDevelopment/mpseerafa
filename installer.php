...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211101_seerafamarketplace_e2ef3745db2aece48137_20211101155624_archive.zip';
	const ARCHIVE_SIZE		 = '70022964';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e2ef374-01155624';
    const SECONDARY_PACKAGE_HASH = '4b86f2a-01155624';
	const VERSION			 = '1.4.3';
